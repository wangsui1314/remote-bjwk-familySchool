package com.bjwk.zrongcloud.io.rong.example.message;

import com.bjwk.zrongcloud.io.rong.RongCloud;
import com.bjwk.zrongcloud.io.rong.messages.TxtMessage;
import com.bjwk.zrongcloud.io.rong.messages.VoiceMessage;
...
import com.bjwk.zrongcloud.io.rong.models.message.*;
 ...
 * @date 2018-03-09
 * @author hc
 * @version 2.0.0   resources.jsonsource
 */
public class MessageExample {
     ...
     * 此处替换成您的appKey
     * */
    private static final String appKey = "3argexb63m0ae";
    /**
     * 此处替换成您的appSecret
     * */
    private static final String appSecret = "CpaSoeOUjm";
